...
rule all:
    input:
      expand(os.path.join(config["outdir"], "{sample}/14_megablast_parsed/megablast_parsed.{n}.{ext}"), sample = "I1164_12629_Harvard_SIV_196_06_2_24_12", n = list(range(1,25)), ext = ["out"])
